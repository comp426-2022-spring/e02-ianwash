...
// 1. Create other variables for assignments, exams, and engagement here
    ...
    let currentMidterm01 = document.querySelector('#m01').value;
    let currentMidterm02 = document.querySelector('#m02').value;
    let currentMidterm03 = document.querySelector('#m03').value;
...
// 2. This line is where you add the points all together. Add your other variable references here. Make sure that they match what is above and what is below in the HTML form
    let sum = parseInt(currentA00) +  parseInt(currentA01) + parseInt(currentA02) + parseInt(currentA03) + parseInt(currentA04) + parseInt(currentA05) + parseInt(currentE01) + parseInt(currentE02) + parseInt(currentMidterm01) + parseInt(currentMidterm02) + parseInt(currentMidterm03) + parseInt(currentA01) + (parseInt(currentCommits)*500);
    setCurrentSum(sum);
  }
  ...
  return (
    <div className="App">
      ...
      <form>
            ...
            <input type="text" id="m01" placeholder="m01" /><br/><br/>
            <input type="text" id="m02" placeholder="m02" /><br/><br/>
            <input type="text" id="m03" placeholder="m03" /><br/><br/>
